...
#include "uclv_robot_lib/robots/MotomanSIA5F.hpp"
...
/*
    Full constructor
*/
MotomanSIA5F::MotomanSIA5F(const Eigen::Isometry3d& n_T_e, const std::string& name)
...
*/
MotomanSIA5F::MotomanSIA5F(const std::string& name) : MotomanSIA5F(Eigen::Isometry3d::Identity(), name)
{
}
...
/*
    Empty constructor
*/
MotomanSIA5F::MotomanSIA5F() : MotomanSIA5F("SIA5F_NO_NAME")
{
}
